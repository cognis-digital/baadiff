#!/usr/bin/env sh
# Universal installer for baadiff. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/baadiff.git"
echo "Installing baadiff ..."
