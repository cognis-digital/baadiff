...
[![PyPI](https://img.shields.io/pypi/v/cognis-baadiff.svg)](https://pypi.org/project/cognis-baadiff/)
[![CI](https://github.com/cognis-digital/baadiff/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/baadiff/actions)
...
BAADIFF exists for one job — scan a repo or infra manifest for hipaa security rule gaps and produce a business associate readiness scorecard. — and does it without a SaaS bill or heavyweight setup.
...
```bash
baadiff --version
baadiff scan .                      # scan the current project
baadiff scan . --format json
baadiff scan . --fail-on high       # non-zero exit for CI gates
baadiff mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Prowler + OpenSCAP**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`baadiff` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
